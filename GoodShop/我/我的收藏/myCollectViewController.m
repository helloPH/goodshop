...
@interface myCollectViewController ()<UIGestureRecognizerDelegate,UIGestureRecognizerDelegate,UITableViewDataSource,UITableViewDelegate,MBProgressHUDDelegate>
{
...
-(void)relodData
{
    ...
    [HTTPTool getWithUrlPath:HTTPHEADER AndUrl:@"showShoucang.action" params:pram success:^(id json) {
        [Hud hide:YES];
...
-(void)initGoodView
{
    ...
    [goodBtn setTitleColor:textBlackColor forState:UIControlStateNormal];
    ...
    [storeBtn setTitleColor:textBlackColor forState:UIControlStateNormal];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [imageview sd_setImageWithURL:imgurl placeholderImage:[UIImage imageNamed:@"yonghutouxiang"] options:SDWebImageRefreshCached];
...
-(void)delData:(NSInteger)index
{
    ...
    NSMutableDictionary *pram = [[NSMutableDictionary alloc]initWithDictionary:@{@"shoucang.userid":user_id,@"shoucang.shoucangtype":typ,@"shoucang.shopid":shangpindid,@"shoucang.dianpuid":dianpuid}];
    [HTTPTool getWithUrlPath:HTTPHEADER AndUrl:@"deleteShoucang.action" params:pram success:^(id json) {

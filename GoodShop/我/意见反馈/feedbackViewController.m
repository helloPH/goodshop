...
-(void)submitAction:(UIButton *)btn
{
    ...
    if ([sdf integerForKey:@"isLogin"]==1) {
        ...
        if (isOk && isMesg) {
            ...
            pram = [[NSMutableDictionary alloc]initWithDictionary:@{@"yiJianFanKui.city":@"",@"yiJianFanKui.shequ":@"",@"yiJianFanKui.username":user_id,@"yiJianFanKui.mobile":numString,@"yiJianFanKui.fankuineirong":opinionTextView.text}];
            
            [HTTPTool postWithUrlPath:HTTPHEADER AndUrl:@"yiJianFanKui.action" params:pram success:^(id json) {
        ...
        if (isOk && isMesg) {
            ...
            NSLog(@"%@",strSysName);
            pram = [[NSMutableDictionary alloc]initWithDictionary:@{@"yiJianFanKui.city":@"",@"yiJianFanKui.shequ":@"",@"yiJianFanKui.username":strSysName,@"yiJianFanKui.mobile":numString,@"yiJianFanKui.fankuineirong":opinionTextView.text}];

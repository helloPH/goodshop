 ...
 */
+(UITextField *)textfieldWithFrame:(CGRect)frame font:(UIFont *)textFont textColor:(UIColor *)textColor backGroundColor:(UIColor *)backgroundcolor textAlignment:(NSTextAlignment)textAlignment keyboardType:(UIKeyboardType)keyboardType borderStyle:(UITextBorderStyle)borderStyle placeholder:(NSString *)placeholder
{
